import { ArrowUpRight, Building2, Leaf, MapIcon, MapPin, Menu, Phone, Smile, Users2, Wrench, } from 'lucide-react'
      ...
      <div className=' flex-col gap-6' >
        <div className=' flex justify-between items-center px-4 py-4'> 
              <button className='px-4 py-2 mt-8 ml-4 gap-3 border border-gray-300 rounded-full text-2xl font-normal flex items-center cursor-pointer hover:bg-blue-800 hover:text-white transition-all duration-300 ease-in-out'> <Building2/> StayScape</button> 
               ...
               <button className='flex items-center ml-130 mt-8 gap-2 py-4 px-2 border border-gray-300 w-16 h-16 rounded-full justify-center cursor-pointer hover:bg-blue-800 hover:text-white transition-all duration-300 ease-in-out '><Phone size={25}/></button>
