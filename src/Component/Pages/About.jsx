  ...
  const About = () => {
    return (
      ...
      <div className='flex items-center border border-gray-400 rounded-4xl w-120 h-30 mt-20 ml-170 gap-5 font-medium'>
      ...
      <p className='leading-[1.3] text-center text-gray-500 mt-20 ml-30 text-4xl font-medium'>"Hi, I'm Shova. My sunny Upper East Side apartment <br/> sits beside Central Park, with museums, cafes, and shops <br/> just a stroll away - your stylish home in the city."</p>
        ...
        {features.map((items, idx) => (
          <div key={idx} className='flex items-center rounded-full border border-gray-300 gap-20 mt-30 h-25 px-6 py-4 mr-10'>
