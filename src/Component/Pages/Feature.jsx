...
const Feature = () => {
  ...
  return (
    <div id='features'>
        <div className='flex flex-col items-center justify-center mt-10'>
            ...
            <p className='text-7xl mt-5 font-medium'>Home Highlights</p>
        </div>
  ...
  <div className='relative '>
   ...
   <h1 className='text-3xl absolute text-white top-50 ml-200 font-medium'>
    ...
    <button className='group absolute flex items-center top-130 left-200 cursor-pointer border border-white h-20 w-fit rounded-full px-4 text-3xl gap-5 bg-white hover:bg-blue-700 duration-300'  onClick={handleClick}> <span className='group-hover:bg-white group-hover:border-white border rounded-full bg-black text-white h-15 w-15 flex items-center justify-center duration-300'><ArrowUpRight size={40} strokeWidth={1} className='group-hover:text-black duration-300'/></span> <span className='group-hover:text-white duration-300'>Reserve Now</span> </button>
